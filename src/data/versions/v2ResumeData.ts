import type { VersionedResumeData } from '../contentTypes';

export const v2ResumeData: VersionedResumeData = {
  impactMetrics: [
  ...
  caseStudies: [
    {
      ...
      summary: 'Introduced an AI-first workflow that combined prompt-driven development, design-to-code acceleration, and reusable implementation patterns.',
      bullets: [
    ...
    },
    {
      ...
      summary: 'Designed AI-driven troubleshooting and copilot-style support experiences that helped users resolve issues with less manual digging.',
      bullets: [
    ...
    },
    {
      ...
      summary: 'Led architecture and implementation for modular applications where scalability, usability, and maintainability all mattered at once.',
      bullets: [
  ...
  testimonialThemes: [
    {
      quote: 'Known for turning vague product ideas into working experiences quickly, which helps teams align faster and make better roadmap decisions.',
      role: 'Representative product/design feedback theme',
    },
    {
      quote: 'Brings architecture depth without losing the craft of implementation—strong at connecting design, engineering, and delivery.',
      role: 'Representative engineering leadership feedback theme',
    },
    {
      quote: 'Especially effective in early-stage UX exploration where prototypes need to be both believable and technically grounded.',
  ...
  contactLinks: [
    { href: 'mailto:meh.manoj@gmail.com', label: 'meh.manoj@gmail.com', icon: 'fa-solid fa-envelope' },
    { href: 'tel:+19496915115', label: '949-691-5115', icon: 'fa-solid fa-phone' },
    { href: 'https://linkedin.com/in/manoj-mehta-4486302', label: 'LinkedIn', icon: 'fa-brands fa-linkedin', external: true },
    { href: 'https://github.com/mehmanoj', label: 'GitHub', icon: 'fa-brands fa-github', external: true },
  ],
};
